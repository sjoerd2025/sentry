...
incorrect_cases = [
    ...
    ("date - datetime space-separated UTC", "2006-01-02 15:04:05Z", "<date>", "<date>Z"),
    (
    ...
    ("date - datetime compressed space-separated", "20060102 150405", "<date>", "<hex> <int>"),
    (
    ...
    ("date - datetime compressed T-separated", "20060102T150405", "<date>", "20060102T150405"),
    (
