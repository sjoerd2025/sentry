...
scm_method_registry: dict[str, Callable] = {
    ...
    "create_review_comment_line_v1": SourceCodeManager.create_review_comment_line,
    "create_review_comment_multiline_v1": SourceCodeManager.create_review_comment_multiline,
    ...
    "resolve_review_thread_v1": SourceCodeManager.resolve_review_thread,
}
