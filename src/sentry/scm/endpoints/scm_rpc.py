...
scm_method_registry: dict[str, Callable] = {
    ...
    "get_issue_comment_reactions": SourceCodeManager.get_issue_comment_reactions,
    "create_issue_comment_reaction": SourceCodeManager.create_issue_comment_reaction,
    "delete_issue_comment_reaction": SourceCodeManager.delete_issue_comment_reaction,
    "get_pull_request_comment_reactions": SourceCodeManager.get_pull_request_comment_reactions,
    "create_pull_request_comment_reaction": SourceCodeManager.create_pull_request_comment_reaction,
    "delete_pull_request_comment_reaction": SourceCodeManager.delete_pull_request_comment_reaction,
    ...
    "get_pull_request_reactions": SourceCodeManager.get_pull_request_reactions,
    "create_pull_request_reaction": SourceCodeManager.create_pull_request_reaction,
    "delete_pull_request_reaction": SourceCodeManager.delete_pull_request_reaction,
    "get_branch": SourceCodeManager.get_branch,
    "create_branch": SourceCodeManager.create_branch,
    "update_branch": SourceCodeManager.update_branch,
    "create_git_blob": SourceCodeManager.create_git_blob,
    "get_file_content": SourceCodeManager.get_file_content,
    "get_commit": SourceCodeManager.get_commit,
    "get_commits": SourceCodeManager.get_commits,
    "compare_commits": SourceCodeManager.compare_commits,
    "get_tree": SourceCodeManager.get_tree,
    "get_git_commit": SourceCodeManager.get_git_commit,
    "create_git_tree": SourceCodeManager.create_git_tree,
    "create_git_commit": SourceCodeManager.create_git_commit,
    "get_pull_request_files": SourceCodeManager.get_pull_request_files,
    "get_pull_request_commits": SourceCodeManager.get_pull_request_commits,
    "get_pull_request_diff": SourceCodeManager.get_pull_request_diff,
    "list_pull_requests": SourceCodeManager.list_pull_requests,
    "create_pull_request": SourceCodeManager.create_pull_request,
    "update_pull_request": SourceCodeManager.update_pull_request,
    "request_review": SourceCodeManager.request_review,
    "create_review_comment": SourceCodeManager.create_review_comment,
    "create_review": SourceCodeManager.create_review,
    "create_check_run": SourceCodeManager.create_check_run,
    "get_check_run": SourceCodeManager.get_check_run,
    "update_check_run": SourceCodeManager.update_check_run,
    "minimize_comment": SourceCodeManager.minimize_comment,
    "resolve_review_thread": SourceCodeManager.resolve_review_thread,
}
